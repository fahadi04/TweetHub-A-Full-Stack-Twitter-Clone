...
function HomeSection() {
    ...
    return (
        <div className='space-y-2 ' >
            <section className='sticky top-0 flex items-center  justify-center cursor-pointer  w-full h-20 rounded-md'>
                <h1 className='py-8 text-3xl text-center font-bold opacity-90 w-[50%] hover:bg-gray-800 '>For you</h1>
                <h1 className='py-8 text-3xl text-center font-bold opacity-90 w-[50%] hover:bg-gray-800'>Following</h1>
            </section>
                ...
                <div className='flex space-x-4 items-start m-3 '>
                    ...
                    <div className="w-full flex justify-between">
                        <form className='w-full' onSubmit={formik.handleSubmit}>
                            <div>
                                <input type="text" name='content' placeholder="What's happening?" className={`border-none outline-none bg-transparent text-white h-auto text-4xl font-normal p-4 w-full `}
                            ...
                            <div className='flex justify-between p-2'>
                                <div className='flex items-center space-x-4 text-blue-500 mt-4'>
                                    <label className='flex items-center cursor-pointer space-x-2  rounded-md'>
                                        ...
                                        <input type="file" accept="image/*" className='hidden' name='imageFile' onChange={handleSelectImage} />
                                    </label>
            ...
            <hr className='border-gray-600' />
            {/* <section className='flex items-center justify-center w-full h-15 rounded-md'>
                <h1 className='text-2xl font-bold opacity-90'>No Tweets yet</h1>
            </section>
            <hr className='border-gray-600' /> */}
            <section>
                <TweetCard />
